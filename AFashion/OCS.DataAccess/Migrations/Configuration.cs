...
namespace OCS.DataAccess.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<Context.FashionContext>
    {
        ...
        protected override void Seed(Context.FashionContext context)
        {
            ...
            defaultProducts.Add(new Product { ID = new Guid("ae6484cb-15a9-45ce-8ef9-7915f7aeb045"), Brand = defaultBrands[1], Category = defaultCategs[0], Price = 100, Name = "Nice Hat", Image = "Nice Hat.jpg" });
            defaultProducts.Add(new Product { ID = new Guid("ad864353-9cb5-4610-b336-1d16bd9ad190"), Brand = defaultBrands[3], Category = defaultCategs[1], Price = 20, Name = "Good Shirt", Image = "Good Shirt.jpg" });
            defaultProducts.Add(new Product { ID = new Guid("fa208521-ea70-4853-8eb0-69ae9fd94329"), Brand = defaultBrands[1], Category = defaultCategs[2], Price = 40, Name = "Grey Pants", Image = "Grey Pants.jpg" });
            defaultProducts.Add(new Product { ID = new Guid("1949c7c5-462c-4f67-8ade-2d729ee3288c"), Brand = defaultBrands[2], Category = defaultCategs[3], Price = 99.9, Name = "DVD Boots", Image = "DVD Boots.jpg" });
            defaultProducts.Add(new Product { ID = new Guid("6cfe3107-4d78-4577-a990-77c682f5db27"), Brand = defaultBrands[0], Category = defaultCategs[3], Price = 25, Name = "Wooden Boots", Image = "Wooden Boots.jpg" });
            defaultProducts.Add(new Product { ID = new Guid("40271f2b-3a3a-41af-b7d9-4ce3df231d43"), Brand = defaultBrands[4], Category = defaultCategs[4], Price = 66, Name = "Red Hood", Image = "Red Hood.jpg" });
            defaultProducts.Add(new Product { ID = new Guid("39e9c067-71ab-416f-8b09-a0c3007785aa"), Brand = defaultBrands[4], Category = defaultCategs[4], Price = 60, Name = "Blue Ocean Dress", Image = "Blue Ocean Dress.jpg" });
