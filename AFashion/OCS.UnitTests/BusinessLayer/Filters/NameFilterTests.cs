...
namespace OCS.UnitTests.BusinessLayer.Filters
{
    ...
    class NameFilterTests
    {
        ...
        public void Resolve_FiltersCorrectly()
        {
            ...
            var filterName = items[5].Name;
            var filter = new NameFilter(items, filterName);
            ...
            Assert.IsTrue(result.Filters.ContainsKey("Name"));
            var filteredItems = result.Filters["Name"] as IList<Product>;
        ...
        public void Resolve_StacksWithOtherFilters()
        {
            ...
            var filter = new NameFilter(new List<Product>(), "SomeFilter", secondFilter.Object);
